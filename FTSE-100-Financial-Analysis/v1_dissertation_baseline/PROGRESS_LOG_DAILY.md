...
|---|---|---|---|---|
| 2024-07-19 | Planning | Repo charter & UK terminal theme (colors, typography, naming). | Theme guide draft | `assets/branding/REPO_THEME_GUIDE.md` |
| 2024-07-20 | Planning | Dashboard Page Spec drafted (7 pages V1, 22 pages V2). | Spec pack | `docs/dashboards/` |
| 2024-07-21 | Planning | Mermaid architecture + lineage skeletons aligned to medallion pattern. | Mermaid set | `docs/mermaid/` |
| 2024-07-22 | Data | Reference data plan: FTSE100 constituents universe + sectors + weights. | Universe schema | `REFERENCE_DATA.md` |
...
| 2024-07-10 | V1 Models | ARIMA baseline training + 10-minute horizon forecasts. | ARIMA metrics + model summary | `v1_dissertation_baseline/outputs/metrics/arima_*` |
| 2024-07-11 | V1 Models | LSTM training pipeline + training history + forecast export. | LSTM metrics + history | `v1_dissertation_baseline/outputs/metrics/lstm_*` |
| 2024-07-12 | V1 Dashboards | V1 dashboard exports (7 pages) rendered at 4K. | V1 export pack | `docs/dashboards/V1/exports/` |
